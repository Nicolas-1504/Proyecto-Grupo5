							...
							<div>
								<div class="form-group d-flex">
									<div class="col-sm-6 d-flex">
										...
										<input type="submit" name="accion" class="btn btn-outline-info" value="Buscar Producto">
									</div>
									<div class="col-sm-6">
								...
								<div class="form-group d-flex">
									<input type="submit" name="accion" value="Agregar Producto" class="btn btn-outline-primary">
								</div>
							</div>
					</div>
				</div>
